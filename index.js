...
function displayQuestion() {
    document.getElementById("question").innerHTML = definitions[Math.random(36)]
}
function clickButtonOne() {
    optionOne = true;
    document.getElementById("btn1").innerHTML = terms[0];
    document.getElementById("question").innerHTML = definitions[Math.random(36)]
}
function clickButtonTwo() {
    optionTwo = true;
    document.getElementById("btn2").innerHTML = terms[1];
    document.getElementById("question").innerHTML = definitions[Math.random(36)]
}
function clickButtonThree() {
    optionThree = true;
    document.getElementById("btn3").innerHTML = terms[2];
    document.getElementById("question").innerHTML = definitions[Math.random(36)]
}
function clickButtonFour() {
    optionFour = true;
    document.getElementById("btn4").innerHTML = terms[3];
    document.getElementById("question").innerHTML = definitions[Math.random(36)]
}
